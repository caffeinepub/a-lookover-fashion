...
export class Backend implements backendInterface {
    ...
    async addCategory(arg0: CategoryUpdate): Promise<void> {
        if (this.processError) {
            try {
    ...
    async addProduct(arg0: ProductUpdate): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async searchProducts(arg0: string, arg1: number, arg2: number, arg3: number): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchProducts(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateCategory(arg0: CategoryUpdate): Promise<void> {
        if (this.processError) {
            try {
